  ...
  return (
    <aside className="grid gap-4 lg:sticky lg:top-24">
      <section className="border border-slate-200 bg-white p-5 shadow-sm">
        ...
        <div className="mb-4 flex h-12 w-12 items-center justify-center bg-gradient-brand text-lg font-black text-white">
          RA
        </div>
        <h2 className="text-xl font-black text-slate-950">{profile?.name || 'Ralph Rong'}</h2>
        <p className="mt-2 text-sm font-medium leading-6 text-slate-600">
          {profile?.headline || 'Android 系统工程师｜智能穿戴 / 安卓系统'}
        </p>
        <a
          href="#profile"
          className="mt-4 inline-flex border border-primary-100 bg-primary-50 px-3 py-2 text-sm font-bold text-primary-700 hover:border-primary-300"
        >
          查看 Ra 个人页
        </a>
      </section>
...
function SiteStatsPanel() {
  ...
  return (
    <aside className="grid gap-4 lg:sticky lg:top-24">
      ...
      <section className="border border-slate-200 bg-white p-5 text-sm leading-6 text-slate-600 shadow-sm">
